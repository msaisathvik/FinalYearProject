...
def load_data(train_csv, val_csv, data_root, distributed):
    ...
    st = time.time()
    # Point to the trainDataset folder (modified for prototype)
    ...
    # Point to the valDataset folder (using valDataset for prototype val as well)
...
if __name__ == "__main__":
    ...
    # Update default paths to point to the correct location (relative to project root)
    parser.add_argument("--train-csv", default='dataset_prototype/train_prototype.csv', help="train csv of HiCervix")
    parser.add_argument("--val-csv", default='dataset_prototype/train_prototype.csv', help="val csv of HiCervix")

    parser.add_argument("--data_dir", default="dataset_prototype", help="Folder containing the dataset (train/val/test folders)")
    parser.add_argument("--output", default='output_hiera_prototype', help="path to the model folder")
